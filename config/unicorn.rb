...
listen '/tmp/metrofuture-in-action.socket', backlog: 64
listen 8012
...
pid '/tmp/unicorn.metrofuture-in-action.pid'

# Production-specific settings
if env == 'production'
  # Help ensure your application will always spawn in the
  # symlinked 'current' directory that Capistrano sets up
  working_directory '/home/deployer/apps/metrofuture-in-action/current'

  # feel free to point this anywhere accessible on the filesystem
  user 'deployer', 'staff'
  shared_path = '/home/deployer/apps/metrofuture-in-action/shared'
...
before_fork do |server, worker|
  ...
  old_pid = '/tmp/unicorn.metrofuture-in-action.pid.oldbin'
