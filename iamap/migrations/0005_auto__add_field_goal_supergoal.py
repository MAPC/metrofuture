...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Goal.supergoal'
        db.add_column('iamap_goal', 'supergoal', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['iamap.Supergoal']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Goal.supergoal'
        db.delete_column('iamap_goal', 'supergoal_id')
    ...
    models = {
        ...
        'iamap.goal': {
            ...
            'supergoal': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['iamap.Supergoal']"}),
